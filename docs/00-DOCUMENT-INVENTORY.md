...
> LICENSE PolyForm Noncommercial 1.0.0; geo locale Q-T16 done; **next = consultative brand session**. Living docs:
...
| Brand (face, tone, color) | `docs/design/BRAND.md` | **P2** / Living | Calendly reference, 2026-09-14. Geist, navy, link-blue. |
