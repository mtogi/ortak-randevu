...
> OAuth (Q-T15) smoked on www; **visual brand accepted**. Living docs:
...
| Brand (face, tone, color) | `docs/design/BRAND.md` | **P2** / Living | Accepted 2026-09-13. Comfort chrome is the kit under the face. |
