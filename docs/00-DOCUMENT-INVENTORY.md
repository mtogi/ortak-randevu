...
> **Current (2026-09-13):** M0–M4 on `main`; guest erasure `9329f44`; Google
> OAuth (Q-T15) smoked on www. Next: visual brand (`docs/design/BRAND.md`). Living docs:
...
| Design System Notes | `docs/design/DESIGN-SYSTEM.md` | **P2** | Tokens, components; filled in the brand slice |
| Brand (face, tone, color) | `docs/design/BRAND.md` | **P2** / Living | Placeholder now; dedicated next chat. Comfort chrome ≠ brand. |
