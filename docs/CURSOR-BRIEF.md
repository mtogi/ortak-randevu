...
7. War plan / build gate: `docs/WAR-PLAN.md`. **M0–M4 done** (www export + delete smoked). Site: `https://www.ortakrandevu.com`. Weekly-hours full-week save is idempotent. Next: copy/CSS polish.
