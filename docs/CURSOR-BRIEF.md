...
7. War plan / build gate: `docs/WAR-PLAN.md`. **M0–M4 done.** Site: `https://www.ortakrandevu.com`. **TR default locale** (2026-09-14) + geo first-visit (Q-T16). LICENSE is PolyForm Noncommercial 1.0.0 (source-available, not OSI). Hygiene queue in ROADMAP Now (items 1–4 done; **item 5 code done**; GSC verified — remaining is Bing + sitemap retry after deploy). One agent, one topic.
