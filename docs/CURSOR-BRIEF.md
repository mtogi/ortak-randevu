...
7. War plan / build gate: `docs/WAR-PLAN.md`. **M0–M4 done.** Site: `https://www.ortakrandevu.com`. Guest self-serve erasure on `main` (`9329f44`). **Google OAuth (Q-T15) smoked on www 2026-09-13.** **Next: visual brand** (`docs/design/BRAND.md`). One agent, one feature.
