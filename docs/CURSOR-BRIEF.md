...
7. War plan / build gate: `docs/WAR-PLAN.md`. **M0–M4 done.** Site: `https://www.ortakrandevu.com`. Guest self-serve erasure on `main` (`9329f44`). **Google OAuth (Q-T15) smoked on www 2026-09-13.** **Visual brand = Calendly reference** (`docs/design/BRAND.md`, 2026-09-14). **Home = conversion landing** (same date). One agent, one feature. Next: owner picks a Later ROADMAP item.
